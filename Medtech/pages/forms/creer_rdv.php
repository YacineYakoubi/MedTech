...
{
$requete="insert into notification set  Contenu='".$_POST['text']."', Praticien_IdPraticien='".$tablep['IdPraticien']."', Patient_IdPatient='".$_GET['id']."'";
                ...
                <div class="box-body"> 
                  ...
                  <div class="bootstrap-timepicker">
                    <div class="form-group">
                      ...
                      <a href="../../profile.html">
                    <button class="btn btn-default pull-right"><i class="fa fa-plus"></i> O K </button>
                    </a>
                </div><!-- /.box-body -->
