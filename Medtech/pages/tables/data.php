  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Table des Patients</a></li>
        <li class="active"></li>
      </ol>
    </section>
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				  ...
				  <th>supprimer un pateint</th>
                </tr>
                </thead>
               
				<?php 
				while($table=mysql_fetch_array($resultat2))
				{
				?>
				 <tbody>
                <tr>
                  <td lang="ar"> <?php echo $table['Nom']."--". $table['NomA']; ?></td>
				  <td lang="ar"> <?php echo $table['Prenom']."--". $table['PrenomA']; ?></td>
				  <td> <?php echo $table['Age']; ?></td>
				  <td> <?php echo $table['NumTel'];  ?></td>
				  <td> <?php echo $table['Categorie']; ?></td>
				 <?php  $requete3="select  	* from  assistantmedical where IdAssistantMedical='".$table['AssistantMedical_IdAssistantMedical']."'";
$resultat3=mysql_query($requete3); 
$assi=mysql_fetch_array($resultat3);
?>
				  <td> <?php echo $assi['NomAM']."--".$assi['PrenomAM']; ?></td>
				  <td>
				  <a href="supp.php?id=<?php echo $table['IdPatient'];?>" ><img src="supp.png" width="30" height="30"></a>
