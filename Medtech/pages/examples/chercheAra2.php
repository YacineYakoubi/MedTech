 ...
 <div class="modal-dialog">
      <div class="modal-content">
			   ...
			   <div class="modal-body">
			    <script src="chercheAR/post1.js" ></script>
               <form action="chercheAR/ajax-search1.php"  method="get" >
                ...
                <div class="modal-footer">
                    ...
                    <button  id ="button" name="button" type="submit" style="font:20px bold;"align="right" class="btn btn-default" data-dismiss="modal"> بحث</button>
