...
{
$requete="insert into patient set Nom='".$_POST['Nom']."', Prenom='".$_POST['Prenom']."', Age='".$_POST['Age']."', NumTel='".$_POST['NumTel']."', Autonomie='".$_POST['Autonomie']."', Addresse='".$_POST['Addresse']."',Categorie='".$_POST['Categorie']."',AssistantMedical_IdAssistantMedical='".$_POST['AM']."',NomA= '".$_POST['NomA']."',PrenomA='".$_POST['PrenomA']."'";
...
//".$_SESSION['username']."'
$requete5="SELECT * FROM praticien WHERE MailP =1";
                ...
                <div class="box-body">
                  <ul class="todo-list">
                    ...
                    <li>
                      ...
                      <input type="checkbox" value="" name="">
                      <span class="text">Faire sport</span>
                    ...
                    <li>
                      ...
                      <input type="checkbox" value="" name="">
                      <span class="text">Faire les analyses</span>
            ...
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Nome</b> <a class="pull-right">1,322</a>
                </li>
                <li class="list-group-item">
                  <b>Prénom</b> <a class="pull-right">543</a>
                </li>
                <li class="list-group-item">
                ...
                <li class="list-group-item">
                  <b>Téléphone</b> <a class="pull-right">13,287</a>
                </li>
              </ul>
            </div>
            <!-- /.box-body -->
