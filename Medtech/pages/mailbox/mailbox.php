...
$req="select * from notification where  Praticien_IdPraticien= '".$tablep['IdPraticien']."'";
$res=mysql_query($req);
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a href="read-mail.php?id=<?php echo $listmail['Patient_IdPatient'];?>"> <?php $requete1="select * from patient where idpatient='".$listmail['Patient_IdPatient']."'" ;
