            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  <tbody>
				  <?php while ($listmail=mysql_fetch_array($res))
				  {?>
                  <tr>
                    <td><input type="checkbox"></td>
                    <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                    <td class="mailbox-name"><a href="read-mail2.php?id=<?php echo $listmail['Patient_IdPatient'];?>"> <?php $requete1="select * from patient where idpatient='".$listmail['Patient_IdPatient']."'" ;
					$resultat1=mysql_query($requete1);
					$tpatient=mysql_fetch_array($resultat1);
					echo $tpatient['Nom']."   ".$tpatient['Prenom'];
					?>
					</a></td>
                    <td class="mailbox-subject"><b><?php echo $listmail['sujet']?></b> 
                    </td>
                    <td class="mailbox-attachment"></td>
                    <td class="mailbox-date"><?php echo $listmail['datareel']?></td>
                  </tr>
                 <?php }?>
                  </tbody>
                </table>
