...
$requete1="select * from suivre where Patient_IdPatient ='".$_GET['id']."'";
$res1=mysql_query($requete1);
$res12=mysql_fetch_array($res1);
$req="select * from notification where  Praticien_IdPraticien= '".$res12['Praticien_IdPraticien']."' and Patient_IdPatient='".$_GET['id']."'";
$res=mysql_query($req);
$table=mysql_fetch_array($res);
$requ="select * from patient where IdPatient ='".$table['Patient_IdPatient']."'";
$resul=mysql_query($requ);
$tabpatient=mysql_fetch_array($resul);
?>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-read-info">
                <h3>le sujet de message</h3>
                <h5>de: <?php echo  $tabpatient['Email'];?>
                  <span class="mailbox-read-time pull-right"><?php     echo $table['datareel']; ?></span></h5>
              </div>
              <!-- /.mailbox-read-info -->
...
<?php     echo $table['Contenu']; ?>
            ...
            <div class="box-footer">
              <div class="pull-right">
                <button type="button" class="btn btn-default"><i class="fa fa-reply"></i> Précédent</button>
                <button type="button" class="btn btn-default"><i class="fa fa-share"></i>Suivant</button>
              </div>
