              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a href="read-mail1.php?id=<?php echo $listmail['Patient_IdPatient'];?>"> <?php $requete1="select * from patient where idpatient='".$listmail['Patient_IdPatient']."'" ;
